return {
  ...
  hl.workspace_rule({ workspace = "6", monitor = "desc:Samsung Electric Company Odyssey G40B HCJW60013" }),
  hl.workspace_rule({ workspace = "7", monitor = "desc:Samsung Electric Company Odyssey G40B HCJW60013" }),
